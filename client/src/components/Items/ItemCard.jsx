...
class ItemCard extends Component {
  ...
  render() {
    ...
    return (
        <Card
      style={{ margin:'5px'}}
      cover={<img alt="example" src={this.props.imgPath} style={{height:'180px'}} />}
      actions={[ <Button size ="small"icon="shopping-cart" onClick={this.addItemToCart.bind(this)}>ADD TO CART</Button>]}
    >
